...
window.onload = function () {
  if (
    ...
    browser.browserAction.setIcon({
      path: "../res/icons/nBother_enabled-32.png",
    });
    browser.browserAction.setTitle({
      title: browser.i18n.getMessage("extensionEnabled"),
    });
    if (value == true) {
      browser.browserAction.setIcon({
        path: "../res/icons/nBother_enabled-32.png",
      ...
      browser.browserAction.setIcon({
        path: "../res/icons/nBother_enabled_off-32.png",
      });
    }
    isMobile = false;
  }
...
function startnBother() {
  if (value == true) {
    ...
    browser.browserAction.setIcon({
      path: "../res/icons/nBother_disabled-32.png",
    });
    browser.tabs.reload();
    if (isMobile == false) {
      browser.browserAction.setTitle({
        title: browser.i18n.getMessage("extensionDisabled"),
      });
    }
    value = false;
